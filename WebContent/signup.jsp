...
<body class="align">
	...
	<div class="grid">
		...
		<form action="SignUpServlet" method="post" class="form login">
			...
			<div class="form__field">
				<label for="login__email"><svg class="icon">
					<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span
					class="hidden">Email</span></label> <input id="login__email"
					type="email" name="email" class="form__input" placeholder="Email"
					required>
			</div>
			...
			<div class="form__field">
				<label for="login__password"><svg class="icon">
					<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#lock"></use></svg><span
					class="hidden">ID</span></label> <input id="login__id"
					type="number" name="id" class="form__input"
					placeholder="Password" required>
			</div>
		...
		<p class="text--center">
			Already an member? <a href="adminLogin.jsp">Login</a>
			<svg class="icon">
	...
	<path
		d="M1600 960q0 54-37 91l-651 651q-39 37-91 37-51 0-90-37l-75-75q-38-38-38-91t38-91l293-293H245q-52 0-84.5-37.5T128 1024V896q0-53 32.5-90.5T245 768h704L656 474q-38-36-38-90t38-90l75-75q38-38 90-38 53 0 91 38l651 651q37 35 37 90z" /></symbol>
