...
<body>
	...
	<svg width="380px" height="500px" viewBox="0 0 837 1045" version="1.1"
		...
		xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"> <g
		id="Page-1" stroke="none" stroke-width="1" fill="none"
		fill-rule="evenodd" sketch:type="MSPage"> <path
		d="M353,9 L626.664028,170 L626.664028,487 L353,642 L79.3359724,487 L79.3359724,170 L353,9 Z"
		id="Polygon-1" stroke="#007FB2" stroke-width="6"
		sketch:type="MSShapeGroup"></path> <path
	...
	<div class="message-box">
		<h1>K.L.N.College Of Engineering</h1>
		<p>Education at its Best...!</p>
		<div class="buttons-con">
			<div class="action-link-wrap">
				<a href="adminLogin.jsp" class="link-button link-back-button">Admin</a>
				<a href="studentLogin.html" class="link-button">Student</a>
			</div>
		</div>
	</div>
