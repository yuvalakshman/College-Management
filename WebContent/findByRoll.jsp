...
.form input[type='password'], .form input[type='number'], .form input[type='submit']
	{
	width: 100%;
}
...
.login label, .login input[type='number'], .login input[type='password'],
...
<body class="align">
	<form method=post action="FindServlet" class="form-signin">
